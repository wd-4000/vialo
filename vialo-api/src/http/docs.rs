...
// ApiDoc and openapi_doc are generated by build.rs with
// absolute paths so utoipauto discovery works regardless of CWD.
include!(concat!(env!("OUT_DIR"), "/api_doc_gen.rs"));
